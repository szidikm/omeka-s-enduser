...
- PHP, minumum version 7.4, with these modules:
	- [PDO](http://php.net/manual/en/intro.pdo.php){target=_blank}, 
	- [pdo_mysql](http://php.net/manual/en/ref.pdo-mysql.php){target=_blank}, 
	- [xml](http://php.net/manual/en/intro.xml.php){target=_blank} extensions 
